jQuery("#simulation")
  .on("click", ".s-ab9f825e-5630-4eab-a818-39f9461e5616 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/922ec842-a117-412e-8dee-aa900c7885ea"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("keydown.jim", ".s-ab9f825e-5630-4eab-a818-39f9461e5616 .keydown", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("mouseleave dragleave", ".s-ab9f825e-5630-4eab-a818-39f9461e5616 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
