jQuery("#simulation")
  .on("click", ".s-976d3a66-6c15-401e-8808-b1429336d5ed .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/6d82d859-9180-4f8f-975b-0a175d7d0999"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("keydown.jim", ".s-976d3a66-6c15-401e-8808-b1429336d5ed .keydown", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
